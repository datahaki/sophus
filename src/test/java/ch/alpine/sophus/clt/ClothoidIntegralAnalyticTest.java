...
class ClothoidIntegralAnalyticTest {
  @Test
  void test1() {
    Scalar _N1_1_4 = Complex.of(+0.7071067811865476, 0.7071067811865475);
    Tolerance.CHOP.requireClose(_N1_1_4, Complex.unit(Pi.QUARTER));
  }

  @Test
  void test2() {
    Scalar _N1_3_4 = Complex.of(-0.7071067811865475, 0.7071067811865476);
    Tolerance.CHOP.requireClose(_N1_3_4, Complex.unit(Pi._3_4));
  }
  ...
  void testSimple1() throws ClassNotFoundException, IOException {
    ...
    Scalar expect = Complex.of(0.1082616101141145, 0.27929038997053457);
  ...
  void testSimple2() {
    ...
    Scalar expect = Complex.of(0.012847600349171472, 0.39973677660732543);
    Tolerance.CHOP.requireClose(result, expect);
  }
  ...
  void testCircle() throws ClassNotFoundException, IOException {
    ...
    Scalar result = clothoidPartial.apply(RealScalar.of(0.3));
    Scalar expect = Complex.of(0.10990181566815083, 0.2785521975010192);
    Tolerance.CHOP.requireClose(result, expect);
  }
  ...
  void testLine() throws ClassNotFoundException, IOException {
    ...
    Scalar result = clothoidPartial.apply(RealScalar.of(0.3));
    Scalar expect = Complex.of(0.0802496485873762, 0.2890674556251579);
    Tolerance.CHOP.requireClose(result, expect);
  }
}
