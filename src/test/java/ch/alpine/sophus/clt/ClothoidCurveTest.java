...
class ClothoidCurveTest {
  ...
  void testComparison() {
    ...
    for (int count = 0; count < 100; ++count) {
      Tensor p = RandomVariate.of(distribution, randomGenerator, 3);
      Tensor q = RandomVariate.of(distribution, randomGenerator, 3);
      Scalar lambda = RandomVariate.of(distribution, randomGenerator);
