...
class Se2BiinvariantMeansTest {
  ...
  void testArsignyPennec() throws ClassNotFoundException, IOException {
    ...
    for (BiinvariantMean biinvariantMean : Se2BiinvariantMeans.values()) {
      ...
      Tensor tangent = MeanDefect.of(sequenceUnordered, weights, Se2Group.INSTANCE.tangentSpace(actual)).tangent();
  ...
  void testTrivial() {
    ...
    for (BiinvariantMean biinvariantMean : Se2BiinvariantMeans.values()) {
      ...
      Tensor tangent = MeanDefect.of(p, weights, Se2Group.INSTANCE.tangentSpace(actual)).tangent();
      Tolerance.CHOP.requireAllZero(tangent);
  ...
  void testTranslation() {
    ...
    for (BiinvariantMean biinvariantMean : Se2BiinvariantMeans.values()) {
      ...
      Tensor tangent = MeanDefect.of(sequence, weights, Se2Group.INSTANCE.tangentSpace(actual)).tangent();
      Tolerance.CHOP.requireAllZero(tangent);
    }
  }
