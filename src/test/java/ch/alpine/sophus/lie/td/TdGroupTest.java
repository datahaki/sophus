...
class TdGroupTest {
  ...
  void testLambdaNonPositiveFail() {
    assertThrows(Exception.class, () -> TdGroup.INSTANCE.isPointQ().require(Tensors.vector(5, 0)));
    assertThrows(Exception.class, () -> TdGroup.INSTANCE.isPointQ().require(Tensors.vector(5, -1)));
  }
  ...
  @Test
  void testDlNullFail() {
    Tensor pE = TdGroup.INSTANCE.isPointQ().require(Tensors.vector(1, 2, 3, 4));
