...
class RnLineDistanceTest {
  ...
  void testSimple() {
    ...
    TensorDistance tensorNorm = lineDistance.distanceToLine(Tensors.vector(10, 0), Tensors.vector(10, 20));
  ...
  void testConsistent() {
    ...
    LineDistance lineDistance2 = new HsLineDistance(RGroup.INSTANCE);
    ...
    for (int d = 2; d < 20; ++d) {
      ...
      Scalar d1 = lineDistance1.distanceToLine(p, q).distance(r);
      Scalar d2 = lineDistance2.distanceToLine(p, q).distance(r);
