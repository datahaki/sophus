...
class GrActionTest {
  ...
  void testSimple(int n) {
    ...
    for (int k = 1; k <= n; ++k) {
      ...
      Tensor p = RandomSample.of(grassmannian.randomSampleInterface(), randomGenerator);
      Tensor q = RandomSample.of(grassmannian.randomSampleInterface(), randomGenerator);
