...
public class ClothoidTerminalRatioTest extends TestCase {
  public void testReverse() {
    ...
    for (int count = 0; count < 100; ++count) {
      ...
      HeadTailInterface headTailInterface2 = Se2Clothoid.of(q, p).curvature();
  ...
  public void testAction() {
    ...
    for (int count = 0; count < 100; ++count) {
      ...
      HeadTailInterface headTailInterface2 = Se2Clothoid.of( //
  ...
  public void testTwoPi() {
    ...
    for (int count = 0; count < 100; ++count) {
      ...
      p.set(Pi.TWO::add, 2);
      q.set(Pi.TWO::add, 2);
      HeadTailInterface headTailInterface2 = Se2Clothoid.of(p, q).curvature();
