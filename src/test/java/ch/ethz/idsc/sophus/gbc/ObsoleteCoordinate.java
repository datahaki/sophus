...
public final class ObsoleteCoordinate implements BarycentricCoordinate, Serializable {
  ...
  public static BarycentricCoordinate of(VectorLogManifold vectorLogManifold, ScalarUnaryOperator variogram) {
    return new ObsoleteCoordinate(vectorLogManifold, new NormalizeLevers(variogram));
  }
  ...
  private ObsoleteCoordinate(VectorLogManifold vectorLogManifold, TensorUnaryOperator target) {
