...
public class CompleteDistancesTest extends TestCase {
  public void testRn() {
    ...
    for (int length = 4; length < 10; ++length) {
      ...
      CompleteDistances d1 = CompleteDistances.frobenius(vectorLogManifold, variogram, sequence);
      CompleteDistances d2 = CompleteDistances.norm2(vectorLogManifold, variogram, sequence);
