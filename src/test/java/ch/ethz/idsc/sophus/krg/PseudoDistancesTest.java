...
public class PseudoDistancesTest extends TestCase {
  public void testAbsolute() {
    ...
    TensorUnaryOperator weightingInterface = //
        pseudoDistances.weighting(RnManifold.INSTANCE, SphericalVariogram.of(Quantity.of(10, "m"), Quantity.of(2, "s")), sequence);
  ...
  public void testRelative() {
    ...
    for (PseudoDistances pseudoDistances : pda) {
      Tensor sequence = RandomVariate.of(distribution, 10, 3);
      TensorUnaryOperator weightingInterface = //
          pseudoDistances.weighting(RnManifold.INSTANCE, SphericalVariogram.of(RealScalar.of(10), Quantity.of(2, "s")), sequence);
      Tensor point = RandomVariate.of(distribution, 3);
      Tensor weights = weightingInterface.apply(point);
      weights.map(QuantityMagnitude.singleton("s"));
    }
