...
public class KrigingTest extends TestCase {
  ...
  public void testSimple() {
    ...
    for (int n = 4; n < 10; ++n) {
      ...
      Kriging kriging1 = Krigings.regression(weightingInterface, points, values, covariance);
      ...
      { // invariant under left action
        ...
        Kriging krigingL = Krigings.regression(weightingInterface, seqlft, values, covariance);
      ...
      { // invariant under right action
        ...
        Kriging krigingR = Krigings.regression(weightingInterface, seqrgt, values, covariance);
      ...
      { // invariant under inversion
        ...
        Kriging krigingI = Krigings.regression(weightingInterface, seqinv, values, covariance);
