...
public class Mahalanobis2DistancesTest extends TestCase {
  public void testRn() {
    ...
    TensorUnaryOperator w1 = PseudoDistances.COMPLETE.normalized(vectorLogManifold, variogram, sequence);
