 ...
 * @see PowerVariogram */
public class LinearKriging implements Kriging, Serializable {
  /** @param variogram
  ...
  public static Kriging interpolation(ScalarUnaryOperator variogram, Tensor sequence, Tensor values) {
    ...
    return new LinearKriging(variogram, sequence, values, Array.zeros(n, n));
  }
  ...
  public static Kriging regression(ScalarUnaryOperator variogram, Tensor sequence, Tensor values, Tensor covariance) {
    return new LinearKriging(variogram, sequence, values, covariance);
  }
   ...
   * @param values
   * @param covariance symmetric matrix */
  private LinearKriging(ScalarUnaryOperator variogram, Tensor sequence, Tensor values, Tensor covariance) {
