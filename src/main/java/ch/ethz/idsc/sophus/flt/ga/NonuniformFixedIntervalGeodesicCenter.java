...
public class NonuniformFixedIntervalGeodesicCenter implements Serializable {
  ...
  public static NonuniformFixedIntervalGeodesicCenter of(SplitInterface splitInterface, ScalarUnaryOperator windowFunction) {
    return new NonuniformFixedIntervalGeodesicCenter( //
